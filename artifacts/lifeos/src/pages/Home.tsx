  ...
  return (
    <div className="min-h-[100dvh] w-full bg-background text-foreground font-sans">
      ...
      <main className="max-w-3xl mx-auto px-6 md:px-10 pb-32">
        ...
        <div className="rounded-2xl border border-border bg-[#111111] dark:bg-[#111111] p-6 relative overflow-hidden backdrop-blur-md">
          {/* Glow blobs */}
          ...
          <form onSubmit={handleGenerate} className="relative z-10 space-y-5" data-testid="form-generate">
